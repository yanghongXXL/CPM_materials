...
knitr::include_graphics("images/0401.png", dpi = 300)
```

```{r , out.width = '100%', echo = FALSE}
knitr::include_graphics("images/0402.png", dpi = 300)
```

```{r , out.width = '100%', echo = FALSE}
knitr::include_graphics("images/0403.png", dpi = 300)
```
...
```{r , out.width = '100%', echo = FALSE}
knitr::include_graphics("images/0404.png", dpi = 300)
```
